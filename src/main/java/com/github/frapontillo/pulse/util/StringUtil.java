...
public class StringUtil {
    ...
    /**
     * Join a {@link List} of {@link String}s with a separator, optionally skipping {@code null} or
     * empty values.
     *
    ...
    /**
     * Join a {@link List} of {@link String}s with a separator, without skipping {@code null} or
     * empty values.
     *
     * @param list The {@link List<String>} to join.
     * @param with The separator {@link String} to use (e.g. ", ").
    ...
    /**
     * Join an array of params {@link String}s with a separator, optionally skipping {@code null}
     * or
     * empty values.
     *
     * @param with     The separator {@link String} to use (e.g. ", ").
    ...
    /**
     * Join an array of params {@link String}s with a separator, without skipping {@code null} or
     * empty values.
     *
     * @param with   The separator {@link String} to use (e.g. ", ").
     * @param params The array of {@link String}s to join.
    ...
    /**
     * Trim a {@link String} at a given character count (or less if the length is less than the
     * input count), then adds the "ellipsis" character.
     *
     * @param s     The {@link String} that will be ellipsized.
     * @param count The maximum number of characters from the input {@link String} that will be
     *              preserved.
     *
     ...
     *
     * @return {@code true} if the source contains at least one of the elements, {@code false}
     * otherwise.
     */
